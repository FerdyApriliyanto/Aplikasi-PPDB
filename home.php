        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="home.php"><img src="images/WK.png" alt="Hair Salon Website Templates Free Download" style="height: 90px"></a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h1 class="hero-title">Website Pendaftaran Siswa Baru</h1>
                    <p class="hero-text"><strong>SMK Wikrama Bogor</strong> </p>
