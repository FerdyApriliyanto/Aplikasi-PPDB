        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="index.php"><img src="images/WK.png" alt="" style="height: 90px"></a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="widget widget-contact">
                        ...
                        <address>
                            <strong>Wikrama</strong>
                            <br> Jl. Raya Wangun,
                            <br> Bogor, POS 19119
                            <br>
                            <abbr title="Phone">P:</abbr> (+62) 822-8728-1111
                        </address>
                        <address>
                            <strong>Contact Name</strong>
                            <br>
                            <a href="mailto:#">smkwikrama.bogor@school.com</a>
                        </address>
                    </div>
                    <!-- /.widget search -->
                ...
                <?php
                    ...
                    if($_GET['menu']=='daftar'){
                        ...
                        $content1=mysqli_query($koneksi , $sql1);
